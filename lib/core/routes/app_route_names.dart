class AppRouteNames {
  ...
  static const String orderedFoodDetailsRoute =
      '/orderedFoodDetailsPage';
  static const String notificationsRoute = '/notificationsPage';

  // User Routes
  static const String userSignupRoute = '/signup';
